---
name: problem-statement-create
description: Generates problem statements based on the SYSMOD methodology.

Use when the user requests a problem statement or when creating a new problem statement. It is used for forward engineering and reverse engineering. 
---
